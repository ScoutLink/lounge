...
<head>
	...
	<!-- Browser tab icon -->
	<link id="favicon" rel="icon" sizes="16x16 32x32 64x64" href="img/favicon.png"
		  data-other="img/favicon-notification.png" data-toggled="false" type="image/x-icon">
	...
	<meta name="application-name" content="ScoutLink Webchat">
